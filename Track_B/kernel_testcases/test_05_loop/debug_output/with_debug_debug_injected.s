...
_Z10loopKernelPii:
	...
	;;#ASMEND
	;;#ASMSTART
		v_mov_b32_e32 v2, 45                        ; result = 45 (constant)
	;;#ASMEND
	;;#ASMSTART
		s_waitcnt lgkmcnt(0)
	;;#ASMEND
	...
	v_mbcnt_hi_u32_b32 v24, -1, v9
	v_mov_b64_e32 v[18:19], 0
	v_readfirstlane_b32 s0, v24
	s_nop 1
	v_cmp_eq_u32_e64 s[0:1], s0, v24
	s_and_saveexec_b64 s[20:21], s[0:1]
	s_cbranch_execz .LBB0_6
	v_mov_b32_e32 v9, 0
	s_waitcnt lgkmcnt(0)
	global_load_dwordx2 v[16:17], v9, s[2:3] offset:24 sc0 sc1
	s_waitcnt vmcnt(0)
	buffer_inv sc0 sc1
	...
	s_waitcnt vmcnt(0)
	global_atomic_cmpswap_x2 v[18:19], v9, v[14:17], s[2:3] offset:24 sc0 sc1
	s_waitcnt vmcnt(0)
	buffer_inv sc0 sc1
...
.LBB0_3:
	...
	v_and_b32_e32 v13, v11, v19
	s_waitcnt vmcnt(0)
	v_mad_u64_u32 v[10:11], s[26:27], v10, 24, v[14:15]
	v_mov_b32_e32 v14, v11
	v_mad_u64_u32 v[14:15], s[26:27], v13, 24, v[14:15]
	v_mov_b32_e32 v11, v14
	global_load_dwordx2 v[16:17], v[10:11], off sc0 sc1
	s_waitcnt vmcnt(0)
	global_atomic_cmpswap_x2 v[10:11], v9, v[16:19], s[2:3] offset:24 sc0 sc1
	s_waitcnt vmcnt(0)
	buffer_inv sc0 sc1
...
.LBB0_6:
	...
	v_mov_b32_e32 v21, 0
	s_waitcnt lgkmcnt(0)
	global_load_dwordx2 v[10:11], v21, s[2:3] offset:40
	...
	s_waitcnt vmcnt(0)
	v_lshl_add_u64 v[10:11], v[14:15], 0, s[26:27]
...
.LBB0_8:
	...
	v_lshl_add_u64 v[18:19], v[16:17], 0, s[22:23]
	s_mov_b32 s24, 0
	...
	s_mov_b32 s25, s24
	s_nop 1
	global_store_dwordx4 v20, v[26:29], s[22:23]
	s_nop 1
	v_mov_b64_e32 v[28:29], s[26:27]
	v_mov_b64_e32 v[26:27], s[24:25]
	global_store_dwordx4 v20, v[26:29], s[22:23] offset:16
	global_store_dwordx4 v20, v[26:29], s[22:23] offset:32
	global_store_dwordx4 v20, v[26:29], s[22:23] offset:48
	s_and_saveexec_b64 s[22:23], s[0:1]
	s_cbranch_execz .LBB0_16
	v_mov_b32_e32 v9, 0
	global_load_dwordx2 v[28:29], v9, s[2:3] offset:32 sc0 sc1
	global_load_dwordx2 v[16:17], v9, s[2:3] offset:40
	v_mov_b32_e32 v26, s20
	v_mov_b32_e32 v27, s21
	s_waitcnt vmcnt(0)
	v_and_b32_e32 v13, s20, v16
	v_and_b32_e32 v16, s21, v17
	v_mul_lo_u32 v17, v16, 24
	v_mul_hi_u32 v22, v13, 24
	v_mul_lo_u32 v16, v13, 24
	v_add_u32_e32 v17, v22, v17
	v_lshl_add_u64 v[22:23], v[14:15], 0, v[16:17]
	global_store_dwordx2 v[22:23], v[28:29], off
	buffer_wbl2 sc0 sc1
	s_waitcnt vmcnt(0)
	global_atomic_cmpswap_x2 v[16:17], v9, v[26:29], s[2:3] offset:32 sc0 sc1
	s_waitcnt vmcnt(0)
...
.LBB0_11:
	...
	buffer_wbl2 sc0 sc1
	s_waitcnt vmcnt(0)
	global_atomic_cmpswap_x2 v[14:15], v9, v[14:17], s[2:3] offset:32 sc0 sc1
	s_waitcnt vmcnt(0)
...
.LBB0_12:
	s_or_b64 exec, exec, s[24:25]
	v_mov_b32_e32 v17, 0
	global_load_dwordx2 v[14:15], v17, s[2:3] offset:16
	...
	buffer_wbl2 sc0 sc1
	s_waitcnt vmcnt(0)
	global_atomic_add_x2 v[14:15], v[16:17], off offset:8 sc1
.LBB0_14:
	s_or_b64 exec, exec, s[26:27]
	s_waitcnt vmcnt(0)
	...
	buffer_wbl2 sc0 sc1
	global_store_dwordx2 v[16:17], v[14:15], off sc0 sc1
	s_sendmsg sendmsg(MSG_INTERRUPT)
.LBB0_16:
	s_or_b64 exec, exec, s[22:23]
	v_lshl_add_u64 v[14:15], v[18:19], 0, v[20:21]
	s_branch .LBB0_20
.LBB0_17:
	s_or_b64 exec, exec, s[22:23]
...
.LBB0_20:
	...
	global_load_dword v9, v[10:11], off offset:20 sc0 sc1
	s_waitcnt vmcnt(0)
	buffer_inv sc0 sc1
...
.LBB0_22:
	...
	v_mov_b32_e32 v9, 0
	global_load_dwordx2 v[10:11], v9, s[2:3] offset:40
	global_load_dwordx2 v[20:21], v9, s[2:3] offset:24 sc0 sc1
	global_load_dwordx2 v[16:17], v9, s[2:3]
	s_waitcnt vmcnt(2)
	v_readfirstlane_b32 s24, v10
	v_readfirstlane_b32 s25, v11
	s_add_u32 s26, s24, 1
	...
	buffer_wbl2 sc0 sc1
	s_waitcnt vmcnt(0)
	global_atomic_cmpswap_x2 v[18:19], v9, v[18:21], s[2:3] offset:24 sc0 sc1
	s_mov_b64 s[20:21], 0
	s_waitcnt vmcnt(0)
...
.LBB0_24:
	...
	buffer_wbl2 sc0 sc1
	s_waitcnt vmcnt(0)
	global_atomic_cmpswap_x2 v[16:17], v9, v[16:19], s[2:3] offset:24 sc0 sc1
	s_waitcnt vmcnt(0)
...
.LBB0_25:
	...
	v_mov_b32_e32 v9, 0
	global_load_dwordx2 v[18:19], v9, s[2:3] offset:24 sc0 sc1
	s_waitcnt vmcnt(0)
	buffer_inv sc0 sc1
	global_load_dwordx2 v[10:11], v9, s[2:3] offset:40
	global_load_dwordx2 v[16:17], v9, s[2:3]
	...
	global_load_dwordx2 v[16:17], v[10:11], off sc0 sc1
	s_waitcnt vmcnt(0)
	global_atomic_cmpswap_x2 v[22:23], v9, v[16:19], s[2:3] offset:24 sc0 sc1
	s_waitcnt vmcnt(0)
	buffer_inv sc0 sc1
...
.LBB0_28:
	...
	s_waitcnt vmcnt(0)
	v_mad_u64_u32 v[10:11], s[26:27], v10, 24, v[16:17]
	v_mov_b32_e32 v16, v11
	v_mad_u64_u32 v[16:17], s[26:27], v13, 24, v[16:17]
	v_mov_b32_e32 v11, v16
	global_load_dwordx2 v[20:21], v[10:11], off sc0 sc1
	s_waitcnt vmcnt(0)
	global_atomic_cmpswap_x2 v[10:11], v9, v[20:23], s[2:3] offset:24 sc0 sc1
	s_waitcnt vmcnt(0)
	buffer_inv sc0 sc1
...
.LBB0_31:
	s_or_b64 exec, exec, s[20:21]
	v_mov_b32_e32 v27, 0
	global_load_dwordx2 v[10:11], v27, s[2:3] offset:40
	...
	s_mul_i32 s26, s24, 24
	s_waitcnt vmcnt(0)
	v_lshl_add_u64 v[10:11], v[18:19], 0, s[26:27]
	s_and_saveexec_b64 s[26:27], s[0:1]
...
.LBB0_33:
	...
	v_mov_b32_e32 v17, 0x202c6425
	v_mov_b32_e32 v16, 0x3d646974
	...
	s_mov_b32 s27, s24
	s_nop 0
	global_store_dwordx4 v26, v[14:17], s[22:23]
	s_nop 1
	v_mov_b32_e32 v14, 0x7074756f
	v_mov_b32_e32 v15, 0x76287475
	v_mov_b32_e32 v16, 0x253d2932
	v_mov_b32_e32 v17, 0xa64
	global_store_dwordx4 v26, v[14:17], s[22:23] offset:16
	s_nop 1
	v_mov_b64_e32 v[14:15], s[24:25]
	v_mov_b64_e32 v[16:17], s[26:27]
	global_store_dwordx4 v26, v[14:17], s[22:23] offset:32
	global_store_dwordx4 v26, v[14:17], s[22:23] offset:48
	s_and_saveexec_b64 s[22:23], s[0:1]
	s_cbranch_execz .LBB0_41
	v_mov_b32_e32 v9, 0
	global_load_dwordx2 v[30:31], v9, s[2:3] offset:32 sc0 sc1
	...
	buffer_wbl2 sc0 sc1
	s_waitcnt vmcnt(0)
	global_atomic_cmpswap_x2 v[16:17], v9, v[28:31], s[2:3] offset:32 sc0 sc1
	s_waitcnt vmcnt(0)
	v_cmp_ne_u64_e32 vcc, v[16:17], v[30:31]
	s_and_saveexec_b64 s[24:25], vcc
...
.LBB0_41:
	s_or_b64 exec, exec, s[22:23]
	v_lshl_add_u64 v[14:15], v[20:21], 0, v[26:27]
	s_branch .LBB0_45
.LBB0_42:
	s_or_b64 exec, exec, s[22:23]
	v_readfirstlane_b32 s22, v9
...
.LBB0_47:
	...
	v_mov_b32_e32 v9, 0
	global_load_dwordx2 v[14:15], v9, s[2:3] offset:40
	global_load_dwordx2 v[22:23], v9, s[2:3] offset:24 sc0 sc1
	global_load_dwordx2 v[16:17], v9, s[2:3]
	s_waitcnt vmcnt(2)
	v_readfirstlane_b32 s24, v14
	v_readfirstlane_b32 s25, v15
	...
	s_add_i32 s21, s24, s21
	s_waitcnt vmcnt(0)
	v_lshl_add_u64 v[18:19], v[16:17], 0, s[20:21]
	v_mov_b32_e32 v20, s0
	global_store_dwordx2 v[18:19], v[22:23], off
	v_mov_b32_e32 v21, s1
	buffer_wbl2 sc0 sc1
	s_waitcnt vmcnt(0)
	global_atomic_cmpswap_x2 v[16:17], v9, v[20:23], s[2:3] offset:24 sc0 sc1
	s_mov_b64 s[20:21], 0
	s_waitcnt vmcnt(0)
...
.LBB0_49:
	...
	buffer_wbl2 sc0 sc1
	s_waitcnt vmcnt(0)
	global_atomic_cmpswap_x2 v[14:15], v9, v[14:17], s[2:3] offset:24 sc0 sc1
	s_waitcnt vmcnt(0)
	v_cmp_eq_u64_e32 vcc, v[14:15], v[16:17]
	s_or_b64 s[20:21], vcc, s[20:21]
	v_mov_b64_e32 v[16:17], v[14:15]
...
.LBB0_53:
	...
	v_and_b32_e32 v13, v15, v19
	s_waitcnt vmcnt(0)
	v_mad_u64_u32 v[14:15], s[26:27], v14, 24, v[16:17]
	v_mov_b32_e32 v16, v15
	v_mad_u64_u32 v[16:17], s[26:27], v13, 24, v[16:17]
	v_mov_b32_e32 v15, v16
	global_load_dwordx2 v[16:17], v[14:15], off sc0 sc1
	s_waitcnt vmcnt(0)
	global_atomic_cmpswap_x2 v[14:15], v9, v[16:19], s[2:3] offset:24 sc0 sc1
	s_waitcnt vmcnt(0)
	buffer_inv sc0 sc1
...
.LBB0_56:
	s_or_b64 exec, exec, s[20:21]
	v_mov_b32_e32 v13, 0
	global_load_dwordx2 v[20:21], v13, s[2:3] offset:40
	global_load_dwordx4 v[14:17], v13, s[2:3]
	v_readfirstlane_b32 s21, v19
	v_readfirstlane_b32 s20, v18
	s_mov_b64 s[22:23], exec
	s_waitcnt vmcnt(1)
	...
	v_mov_b32_e32 v22, 2
	v_mov_b32_e32 v23, 1
	global_store_dwordx4 v[18:19], v[20:23], off offset:8
.LBB0_58:
	s_or_b64 exec, exec, s[26:27]
	s_lshl_b64 s[22:23], s[24:25], 12
	v_lshl_add_u64 v[16:17], v[16:17], 0, s[22:23]
	v_and_b32_e32 v9, 0xffffff1d, v10
	v_or_b32_e32 v10, 0x42, v9
	...
	s_mov_b32 s26, s24
	s_mov_b32 s27, s24
	global_store_dwordx4 v26, v[10:13], s[22:23]
	s_nop 1
	v_mov_b32_e32 v10, s24
	v_mov_b32_e32 v11, s24
	global_store_dwordx4 v26, v[8:11], s[22:23] offset:16
	s_nop 1
	v_mov_b64_e32 v[8:9], s[24:25]
	v_mov_b64_e32 v[10:11], s[26:27]
	global_store_dwordx4 v26, v[8:11], s[22:23] offset:32
	global_store_dwordx4 v26, v[8:11], s[22:23] offset:48
	s_and_saveexec_b64 s[22:23], s[0:1]
	s_cbranch_execz .LBB0_66
	v_mov_b32_e32 v16, 0
	global_load_dwordx2 v[22:23], v16, s[2:3] offset:32 sc0 sc1
	global_load_dwordx2 v[8:9], v16, s[2:3] offset:40
	...
	buffer_wbl2 sc0 sc1
	s_waitcnt vmcnt(0)
	global_atomic_cmpswap_x2 v[10:11], v16, v[20:23], s[2:3] offset:32 sc0 sc1
	s_waitcnt vmcnt(0)
...
.LBB0_61:
	...
	buffer_wbl2 sc0 sc1
	s_waitcnt vmcnt(0)
	global_atomic_cmpswap_x2 v[8:9], v16, v[8:11], s[2:3] offset:32 sc0 sc1
	s_waitcnt vmcnt(0)
...
.LBB0_70:
	...
	global_load_dword v8, v[18:19], off offset:20 sc0 sc1
	s_waitcnt vmcnt(0)
	buffer_inv sc0 sc1
...
.Lfunc_end0:
	...
	.set _Z10loopKernelPii.num_vgpr, 32
	.set _Z10loopKernelPii.num_agpr, 0
	.set _Z10loopKernelPii.numbered_sgpr, 28
