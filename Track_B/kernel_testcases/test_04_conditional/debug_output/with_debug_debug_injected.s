...
_Z17conditionalKernelPKiPii:
	...
	;;#ASMEND
	;;#ASMSTART
		global_load_dword v3, v[2:3], off           ; Load input[tid]
	;;#ASMEND
	;;#ASMSTART
		s_waitcnt vmcnt(0)
	;;#ASMEND
	...
	;;#ASMEND
	;;#ASMSTART
		v_and_b32_e32 v2, 1, v3                     ; v2 = input & 1
	;;#ASMEND
	;;#ASMSTART
		v_cmp_eq_u32_e32 vcc, 1, v2                 ; if odd
	;;#ASMEND
	;;#ASMSTART
...
.LBB0_33:
	...
	s_movk_i32 s22, 0xff1f
	v_and_or_b32 v12, v12, s22, 64
	v_lshlrev_b32_e32 v24, 6, v22
	v_mov_b32_e32 v15, 0x76203a74
	v_mov_b32_e32 v14, 0x75706e49
...
.LBB0_81:
	...
	v_mov_b32_e32 v25, 0
	global_load_dwordx2 v[8:9], v25, s[2:3] offset:40
	global_load_dwordx4 v[12:15], v25, s[2:3]
	v_readfirstlane_b32 s21, v17
	v_readfirstlane_b32 s20, v16
	s_mov_b64 s[22:23], exec
	s_waitcnt vmcnt(1)
...
.LBB0_83:
	...
	s_mov_b32 s27, s24
	s_nop 1
	global_store_dwordx4 v24, v[18:21], s[22:23]
	s_nop 1
	v_mov_b64_e32 v[18:19], s[24:25]
	v_mov_b64_e32 v[20:21], s[26:27]
	global_store_dwordx4 v24, v[18:21], s[22:23] offset:16
	global_store_dwordx4 v24, v[18:21], s[22:23] offset:32
	global_store_dwordx4 v24, v[18:21], s[22:23] offset:48
	s_and_saveexec_b64 s[22:23], s[0:1]
...
.LBB0_91:
	s_or_b64 exec, exec, s[22:23]
	v_lshl_add_u64 v[12:13], v[16:17], 0, v[24:25]
	s_branch .LBB0_95
.LBB0_92:
	s_or_b64 exec, exec, s[22:23]
	v_readfirstlane_b32 s22, v11
...
.LBB0_108:
	...
	v_or_b32_e32 v12, 0xa0, v11
	v_mov_b32_e32 v15, 0x203a7475
	v_mov_b32_e32 v14, 0x7074754f
	v_readfirstlane_b32 s22, v18
	v_readfirstlane_b32 s23, v19
	s_nop 4
	global_store_dwordx4 v24, v[12:15], s[22:23]
	s_nop 1
	v_mov_b32_e32 v12, 0x253d3276
	v_mov_b32_e32 v13, 0x6f282064
	v_mov_b32_e32 v14, 0x3e2d6464
	v_mov_b32_e32 v15, 0x312b7833
	global_store_dwordx4 v24, v[12:15], s[22:23] offset:16
	s_nop 1
	v_mov_b32_e32 v12, 0x7665202c
	v_mov_b32_e32 v13, 0x3e2d6e65
	v_mov_b32_e32 v14, 0xa297832
	v_mov_b32_e32 v15, v25
	global_store_dwordx4 v24, v[12:15], s[22:23] offset:32
	s_nop 1
...
.Lfunc_end0:
	...
	.set _Z17conditionalKernelPKiPii.num_vgpr, 30
	.set _Z17conditionalKernelPKiPii.num_agpr, 0
	.set _Z17conditionalKernelPKiPii.numbered_sgpr, 28
