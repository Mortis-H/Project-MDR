...
_Z9memoryOpsPKiPii:
	...
	;;#ASMEND
	;;#ASMSTART
		global_load_dword v2, v[2:3], off           ; Load input[tid]
	;;#ASMEND
	;;#ASMSTART
	...
	;;#ASMEND
	;;#ASMSTART
		v_lshl_or_b32 v2, v2, 1, 1                  ; v2 = (v2 << 1) | 1
	;;#ASMEND
	;;#ASMSTART
	v_mov_b32 v5, v2
	;;#ASMEND
...
.LBB0_33:
	...
	v_mov_b32_e32 v15, 0x73206572
	v_mov_b32_e32 v14, 0x6f666542
	v_readfirstlane_b32 s22, v18
	v_readfirstlane_b32 s23, v19
	s_nop 4
	global_store_dwordx4 v24, v[12:15], s[22:23]
	s_nop 1
	v_mov_b32_e32 v12, 0x74666968
	v_mov_b32_e32 v13, 0x6e69203a
	v_mov_b32_e32 v14, 0x28747570
	v_mov_b32_e32 v15, 0x3d293276
	global_store_dwordx4 v24, v[12:15], s[22:23] offset:16
	s_nop 1
	v_mov_b32_e32 v12, 0xa6425
...
.LBB0_108:
	...
	v_and_b32_e32 v11, 0xffffff1f, v12
	v_or_b32_e32 v12, 0x80, v11
	v_mov_b32_e32 v15, 0x68732072
	v_mov_b32_e32 v14, 0x65746641
	v_readfirstlane_b32 s22, v18
	v_readfirstlane_b32 s23, v19
	s_nop 4
	global_store_dwordx4 v24, v[12:15], s[22:23]
	s_nop 1
	v_mov_b32_e32 v12, 0x3a746669
	v_mov_b32_e32 v13, 0x74756f20
	v_mov_b32_e32 v14, 0x28747570
	v_mov_b32_e32 v15, 0x3d293276
	global_store_dwordx4 v24, v[12:15], s[22:23] offset:16
	s_nop 1
...
.Lfunc_end0:
	...
	.set _Z9memoryOpsPKiPii.num_vgpr, 30
	.set _Z9memoryOpsPKiPii.num_agpr, 0
	.set _Z9memoryOpsPKiPii.numbered_sgpr, 28
