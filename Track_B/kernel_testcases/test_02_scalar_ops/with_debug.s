...
; @PRINT fmt="tid=%d, v1=tid+1=%d" reg=v0,v1 type=i32,i32
...
; @PRINT fmt="After ops: v2=%d, v1=%d, v5=%d" reg=v2,v1,v5 type=i32,i32,i32
	v_add3_u32 v2, v2, v1, v5                   ; v2 = v2 + v1 + v5 (final)
	v_ashrrev_i32_e32 v1, 31, v0
	s_waitcnt lgkmcnt(0)
	v_lshl_add_u64 v[0:1], v[0:1], 2, s[0:1]
; @PRINT fmt="Final result: v2=%d" reg=v2 type=i32
