...
; ============================================================
; Atomic Timestamp Mode V2
; 
; 方法：使用 C buffer 末尾的空間存儲 timestamp
; Host 端需要分配: C_size + 16 bytes
; 
; Timestamp Buffer 位於: C + N * sizeof(float)
;   [0:7]   min_start - atomically updated
;   [8:15]  max_end   - atomically updated
;
; kernel_wall_time = max_end - min_start
; ============================================================
; @TIMESTAMP_START label="kernel" mode=atomic
...
; ============================================================
; End timestamp - atomic max update
; ============================================================
; @TIMESTAMP_END label="kernel" mode=atomic
